    ...
    <div class="col-10" id="main">
        <form action="" method="post">
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="tomografo">Toggle this switch element</label>
            </div>
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="traumatologoGuardia">Toggle this switch element</label>
            </div>
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="cirujanoGuardia">Toggle this switch element</label>
            </div>
            ...
            <div class="custom-control custom-switch">
                ...
                <label class="custom-control-label" for="cardiologoGuardia">Toggle this switch element</label>
            </div>
